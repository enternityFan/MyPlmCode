...
class GloveModel(nn.Module):
    ...
    def forward_w(self,words):
        ...
        w_biases = self.w_bias(words)
        return w_embeds,w_biases

    def forward_c(self,contexts):
        c_embeds = self.c_embeddings(contexts)
        c_biases = self.c_bias(contexts)
